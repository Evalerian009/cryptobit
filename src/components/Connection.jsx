        ...
        <div className={`${styles.maxWidth} `}>
            <div className='${styles.flex}'>
                ...
                <div className='md:w-1/2'>
                    ...
                    <button className='bg-stone-900 w-fit px-7 rounded-[50px] flex items-center gap-3 py-3 border border-stone-400 mt-7'>
            ...
            <div className={`${styles.paddingY}`}>
                ...
                <div className='mt-14'>
                    <div className="md:w-1/2 lg:w-1/3 text-center flex flex-col gap-4 p-7">
                        ...
                        <h4 className='text-xl text-stone-100'>Collect Currency</h4>
            ...
            <div className={`${styles.paddingY}`}>
                ...
                <div className='mt-10'>
                    <div className='md:w-1/2'>
                        ...
                        <div className='w-full h-[300px] bg-slate-900 mt-5 rounded-2xl'>
                            {/* Image goes here */}
                        </div>
